...
import { PlaceOrder } from "../../../../../src/api/user/orders";
import { AuthContext } from "../../../../../src/api/context/authContext";
import { clearCartByRestaurantApi  } from "../../../../../src/api/user/addTocartApi.js";
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      if (res?.success) {
        resetCheckout();
        clearCart();
        await clearCartByRestaurantApi (billing.restaurantId);
        router.replace("/user/orderSuccess");
      } else {
